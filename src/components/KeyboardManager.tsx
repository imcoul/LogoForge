    ...
    <div id="keyboard-manager-root">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white dark:bg-zinc-900 border border-neutral-200 dark:border-zinc-800 w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[85vh]">
            <div className="p-6 border-b border-neutral-200 dark:border-zinc-800 flex justify-between items-center bg-neutral-50 dark:bg-zinc-900/50">
              <div className="flex items-center gap-3">
                <Keyboard className="text-brand-lead dark:text-indigo-400" size={24} />
                <div>
                  <h3 className="text-lg font-bold text-neutral-900 dark:text-white">Command Center Shortcuts</h3>
            ...
            <div className="p-4 bg-neutral-50 dark:bg-zinc-900 border-t border-neutral-200 dark:border-zinc-800 flex justify-between">
              <button
                onClick={resetToDefault}
                className="flex items-center gap-1.5 text-xs text-neutral-500 hover:text-neutral-800 dark:text-zinc-400 dark:hover:text-zinc-200 hover:underline"
              >
                <RefreshCw size={12} /> Reset to Defaults
              </button>
              <button
                onClick={() => setIsModalOpen(false)}
                className="px-4 py-2 bg-neutral-900 text-white dark:bg-white dark:text-black rounded-xl text-xs font-bold tracking-wide uppercase hover:bg-neutral-800 dark:hover:bg-neutral-100 transition-all flex items-center gap-1"
              >
                <Check size={14} /> Done
              </button>
            </div>
